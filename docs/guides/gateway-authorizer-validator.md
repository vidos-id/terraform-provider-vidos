...
This guide explains the [`examples/gateway-authorizer-validator`](https://github.com/vidos-id/terraform-provider-vidos/tree/main/examples/gateway-authorizer-validator) configuration.
